    ...
    <?php
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <?php
            if($_SESSION['isArtist']=="artist"){
              echo '<a class="nav-link" href="myPage_artist.php">마이페이지</a>';
              //echo "<a class='nav-link' href='/drawingDay/myClassPage.php'>내 클래스 관리</a>";
            }elseif($_SESSION['isArtist']=="member"){
              echo '<a class="nav-link" href="myPage_member.php">마이페이지</a>';
            }
          ?>
          <!-- <a class="nav-link" href="/drawingDay/myPage_member.php">마이페이지</a> -->
          </li>
  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('http://localhost/drawingDay/image/oil_pastel.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>"Drawing-Day"는</h3>
            <p>다양한 종류의 드로잉 원데이 클래스를 소개합니다</p>
          </div>
        </div>
        <!-- Slide Two - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('http://localhost/drawingDay/image/ipad2.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>"Drawing-Day"는</h3>
            <p>믿을 수 있는 수업과 투명한 리뷰를 지향합니다</p>
          </div>
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('http://localhost/drawingDay/image/youtube.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>"Drawing-Day"와 함께</h3>
            <p>특별한 추억을 만들어 보세요!</p>
          </div>
        </div>
      </div>
